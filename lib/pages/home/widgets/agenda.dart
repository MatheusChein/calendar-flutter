...
class _AgendaViewCalendarState extends State<AgendaViewCalendar> {
  ...
  Widget build(BuildContext context) {
    return _getAgendaViewCalendar(_events, _onViewChanged, _calendarController);
  }
  ...
  void _onViewChanged(ViewChangedDetails visibleDatesChangedDetails) {
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      if (DateTime.now().isAfter(visibleDatesChangedDetails.visibleDates[0]) &&
  ...
  SfCalendar _getAgendaViewCalendar(
    ...
    return SfCalendar(
      ...
      monthViewSettings:
          MonthViewSettings(showAgenda: true, numberOfWeeksInView: 2),
